...
#c240dc1921f44585bdc093b20212edee
#c17d5d1d2399411c9be2cf1c0a894fa5
class NewsApp:

    def __init__(self):

        # fetch data
        self.data = requests.get('https://newsapi.org/v2/top-headlines?country=in&apiKey=c17d5d1d2399411c9be2cf1c0a894fa5').json()
        # initial GUI load
        self.load_gui()
